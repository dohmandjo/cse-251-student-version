...
# from prove.setup import setup as ensure_assignment_is_setup
...
def main():
    ...
    image=[rf'prove/elephant/image{img:03d}.png' for img in range (1,301)]
    green=[rf'prove/green/image{grn:03d}.png' for grn in range (1,301)]
    process=[rf'prove/elephant/image{grn:03d}.png' for grn in range (1,301)]
    ...
    for i in range(1,CPU_COUNT+1):
      ...
      with mp.Pool(i) as p:
        p.map(map_create_new_frame, zip(image, green, process))
    ...
    image_file = rf'prove/elephant/image{image_number:03d}.png'
    green_file = rf'prove/green/image{image_number:03d}.png'
    process_file = rf'prove/processed/image{image_number:03d}.png'
